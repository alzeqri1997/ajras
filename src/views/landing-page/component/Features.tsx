...
const Features = () => {
  return (
    <section className="container mt-[104px]" >
      <h1 className="font-semibold text-[20px] leading-[24px] block text-center text-[#24754F]" >فوائد المنصة</h1>
      <h1 className="font-bold text-[44px] leading-[52.8px] text-center text-[#0E2E1F]" >أنواع مختلفة من الفوائد لدينا!</h1>
